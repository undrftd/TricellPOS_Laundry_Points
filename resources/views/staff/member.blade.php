...
<!---content of tabs start-->
  ...
  <div class="col-md-4">
    <form class="form ml-auto" action="/staff/accounts/search_member" method="GET">
  ...
  $.ajax({
    type: 'POST',
    url: '/staff/accounts/reload_member',
    data: {
            '_token': $('input[name=_token]').val(),
  ...
  $.ajax({
    type: 'POST',
    url: '/staff/accounts/update_member',
    data: {
            '_token': $('input[name=_token]').val(),
  ...
  $.ajax({
    type: 'POST',
    url: '/staff/accounts/delete_member',
    data: {
      '_token': $('input[name=_token]').val(),
